...
if (!empty($arResult['ITEMS'])){
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if(!empty($arItem["PREVIEW_PICTURE"]))
			$arItem['IMG'] = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"], array( "width" => 91, "height" => 91 ), BX_RESIZE_IMAGE_PROPORTIONAL,true );
		elseif(!empty($arItem["DETAIL_PICTURE"]))
			$arItem['IMG'] = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], array( "width" => 91, "height" => 91 ), BX_RESIZE_IMAGE_PROPORTIONAL,true );
