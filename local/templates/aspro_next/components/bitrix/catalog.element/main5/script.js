...
$(document).ready(function (){
	...
	$('.info_ext_block .title').click(function(){
...
window.JCCatalogElement.prototype.setBuyBlock = function(th, obj)
{
	...
	if(th.find('.gift_form').length)
	{
		var gift_form = th.find('.gift_form span span');
		gift_form.data('autoload-product_name', obj.NAME);
		gift_form.data('autoload-product_id', obj.ID);
		if('URL' in obj)
			gift_form.data('autoload-product_link', location.origin+''+obj.URL);
		else
			gift_form.data('autoload-product_link', location.origin+''+location.pathname);
	}
